...
public class InsertDeleteUpdateTest {
	...
	//해당 객체는 업캐스팅으로 부모 타임 인터페이스 변수에 저장
	JpaBookRepository jpaBook;
	
	@Test
	void inserUpdateDelete() {
		...
		//데이터베이스 Update 할 Book 객체
		Book book02 = selectList.get();
		book02.setPrice("88000");
		//데이터베이스 bookid가 9인 책의 가격 88,000원으로 수정 -> bookid가 존재하면 수정
		jpaBook.save(book02);
		
		//Book 테이블 bookid가 4인 책 삭제
